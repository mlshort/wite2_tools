...
def mock_ob_csv(tmp_path) -> str:
    ...
    content = (
        # header
        "id,name,suffix,nat,firstYear,firstMonth,lastYear,lastMonth,type, \
        upgrade\n"
...
def test_get_valid_ob_upgrade_ids(mock_ob_csv):
    ...
    # Only 20 should be captured (from ID 10). ID 0 is skipped, Type 0 is
    # skipped, ID 12 has upgrade 0.
