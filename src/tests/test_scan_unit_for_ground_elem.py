...
def test_scan_unit_for_ground_elem_any_quantity(mock_unit_csv, mock_ground_csv, mock_ob_csv):
    ...
    """
    # In conftest.py, ID 42 is at 'sqd.u5' in Unit ID 100 with a quantity of 10.
...
def test_scan_unit_for_ground_elem_exact_quantity(mock_unit_csv, mock_ground_csv, mock_ob_csv):
